...
// GetResourceAccessErrorMeaning returns a human-readable meaning of an error code in an error
// response from a resource access request, per §7.2.  Returns an empty string for unknown error
// codes.
