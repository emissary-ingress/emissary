...
* [Configuring Ambassador](reference/configuration.md)
  ...
  * [Services](reference/services.md)
    * [AuthService](reference/auth-service.md)
    * [RateLimitService](reference/rate-limit-service.md)
...
* [Rate Limit With an External Rate Limit Service](reference/rate-limit-external.md)
