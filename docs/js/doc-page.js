...
export default ({ data, location }) => {
  ...
  // Finally, build the canonical URL: we know the initial part (docs/1.3)
  // and need to append the rest of the original slug to it
  const canonicalUrl = `https://www.getambassador.io/docs/1.3${removeDoubleSlashes(
  ...
  return (
    <React.Fragment>
      ...
      <Layout location={location}>
        ...
        <DocFooter page={page} branch="release/v1.3" />
      </Layout>
    </React.Fragment>
  );
};
