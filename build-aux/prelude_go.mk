...
_prelude.go.error_unsupported = $(error This Makefile requires Go '1.18' or newer; you $(if $(_prelude.go.HAVE),have '$(_prelude.go.VERSION)',do not seem to have Go))
_prelude.go.ensure = $(if $(call _prelude.go.VERSION.HAVE,1.18),,$(_prelude.go.error_unsupported))
