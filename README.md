...
| RFC 5234                                                         | ABNF                                          | `github.com/datawire/liboauth2/syntax/rfc5234`              | RFC 6749                                                            |
...
|------------------------------------------------------------------|-----------------------------------------------|-------------------------------------------------------------|---------------------------------------------------------------------|
| RFC 7230                                                         | HTTP/1.1 Syntax                               | `net/http` & `github.com/datawire/liboauth2/syntax/rfc7230` | RFC 6749 (via RFC 2616)                                             |
...
| RFC 7235                                                         | HTTP/1.1 Authentication                       | `github.com/datawire/liboauth2/syntax/rfc7235`              | RFC 6749 (via RFC 2616, RFC 2617)                                   |
...
| RFC 5234                                                         | ABNF                                          | `github.com/datawire/liboauth2/syntax/rfc5234`              | RFC 6750                                                            |
...
|------------------------------------------------------------------|-----------------------------------------------|-------------------------------------------------------------|---------------------------------------------------------------------|
| RFC 7230                                                         | HTTP/1.1 Syntax                               | `net/http` & `github.com/datawire/liboauth2/syntax/rfc7230` | RFC 6750 (via RFC 2616)                                             |
...
| RFC 7235                                                         | HTTP/1.1 Authentication                       | `github.com/datawire/liboauth2/syntax/rfc7235`              | RFC 6750 (via RFC 2616, RFC 2617)                                   |
