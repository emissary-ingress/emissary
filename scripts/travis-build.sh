...
# We used to try to NOT build the Docker images for doc-only changes, but that ends 
# up being kind of fragile around the autogenerated YAML stuff. Screw it -- just build
