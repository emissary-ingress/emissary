...
type Diagnostics struct {
	...
	SnapshotTs *timestamp.Timestamp `protobuf:"bytes,6,opt,name=snapshot_ts,json=snapshotTs,proto3" json:"snapshot_ts,omitempty"`
}
...
func (x *Diagnostics) GetSnapshotTs() *timestamp.Timestamp {
	if x != nil {
		return x.SnapshotTs
	}
	return nil
