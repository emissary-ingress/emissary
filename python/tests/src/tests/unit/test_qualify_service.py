...
from ambassador.ir.irbasemapping import normalize_service_name  # noqa: E402
...
def test_qualify_service():
    ...
    assert (
        normalize_service_name(ir, "backoffice.otherns", "default", "ConsulResolver")
        == "backoffice.otherns"
    )
    assert (
        normalize_service_name(ir, "backoffice.otherns", "otherns", "ConsulResolver")
        == "backoffice.otherns"
    )
    ...
    assert (
        ...
        == "[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "[fe80::e022:9cff:fecc:c7c4]", "default")
        == "[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "[fe80::e022:9cff:fecc:c7c4]", "other")
        == "[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]", None)
        == "https://[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]", "default")
        == "https://[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]", "other")
        == "https://[fe80::e022:9cff:fecc:c7c4]"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]:443", None)
        == "https://[fe80::e022:9cff:fecc:c7c4]:443"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]:443", "default")
        == "https://[fe80::e022:9cff:fecc:c7c4]:443"
    )
    assert (
        qualify_service_name(ir, "https://[fe80::e022:9cff:fecc:c7c4]:443", "other")
        == "https://[fe80::e022:9cff:fecc:c7c4]:443"
    )
    assert (
    ...
    assert (
        normalize_service_name(ir, "backoffice.otherns:80", "default", "ConsulResolver")
        == "backoffice.otherns:80"
    )
    assert (
        normalize_service_name(ir, "backoffice.otherns:80", "otherns", "ConsulResolver")
        == "backoffice.otherns:80"
    )
    ...
    assert (
        qualify_service_name(ir, "http://backoffice.otherns", "otherns")
        == "http://backoffice.otherns"
    )

    assert (
        normalize_service_name(ir, "http://backoffice", None, "ConsulResolver")
        == "http://backoffice"
    )
    assert (
    ...
    assert (
        normalize_service_name(ir, "http://backoffice", "otherns", "ConsulResolver")
        == "http://backoffice"
    )
    assert (
        normalize_service_name(ir, "http://backoffice.otherns", None, "ConsulResolver")
        == "http://backoffice.otherns"
    )
    assert (
    ...
    assert (
        qualify_service_name(ir, "http://backoffice.otherns:80", None)
        == "http://backoffice.otherns:80"
    )
    assert (
        qualify_service_name(ir, "http://backoffice.otherns:80", "default")
        == "http://backoffice.otherns:80"
    )
    assert (
        qualify_service_name(ir, "http://backoffice.otherns:80", "otherns")
        == "http://backoffice.otherns:80"
    )

    assert (
        normalize_service_name(ir, "http://backoffice:80", None, "ConsulResolver")
        == "http://backoffice:80"
    )
    assert (
        normalize_service_name(ir, "http://backoffice:80", "default", "ConsulResolver")
        == "http://backoffice:80"
    )
    assert (
        normalize_service_name(ir, "http://backoffice:80", "otherns", "ConsulResolver")
        == "http://backoffice:80"
    )
    assert (
        normalize_service_name(
    ...
    assert (
        qualify_service_name(ir, "https://backoffice.otherns", "otherns")
        == "https://backoffice.otherns"
    )

    assert (
        normalize_service_name(ir, "https://backoffice", None, "ConsulResolver")
        == "https://backoffice"
    )
    assert (
    ...
    assert (
        normalize_service_name(ir, "https://backoffice", "otherns", "ConsulResolver")
        == "https://backoffice"
    )
    assert (
        normalize_service_name(ir, "https://backoffice.otherns", None, "ConsulResolver")
        == "https://backoffice.otherns"
    )
    assert (
        normalize_service_name(
    ...
    assert (
        qualify_service_name(ir, "https://backoffice.otherns:443", None)
        == "https://backoffice.otherns:443"
    )
    assert (
        qualify_service_name(ir, "https://backoffice.otherns:443", "default")
        == "https://backoffice.otherns:443"
    )
    assert (
        qualify_service_name(ir, "https://backoffice.otherns:443", "otherns")
        == "https://backoffice.otherns:443"
    )

    assert (
        normalize_service_name(ir, "https://backoffice:443", None, "ConsulResolver")
        == "https://backoffice:443"
    )
    assert (
        normalize_service_name(
    ...
    assert (
        normalize_service_name(ir, "localhost.otherns", "default", "ConsulResolver")
        == "localhost.otherns"
    )
    assert (
        normalize_service_name(ir, "localhost.otherns", "otherns", "ConsulResolver")
        == "localhost.otherns"
    )
    ...
    assert (
        normalize_service_name(ir, "localhost.otherns:80", "default", "ConsulResolver")
        == "localhost.otherns:80"
    )
    assert (
        normalize_service_name(ir, "localhost.otherns:80", "otherns", "ConsulResolver")
        == "localhost.otherns:80"
    )
    ...
    assert (
        qualify_service_name(ir, "http://localhost.otherns", "otherns")
        == "http://localhost.otherns"
    )
    ...
    assert (
        normalize_service_name(ir, "http://localhost", "otherns", "ConsulResolver")
        == "http://localhost"
    )
    # It's not meaningful to actually say "localhost.otherns", but it should passed through unchanged.
    assert (
        normalize_service_name(ir, "http://localhost.otherns", None, "ConsulResolver")
        == "http://localhost.otherns"
    )
    assert (
        normalize_service_name(
    ...
    assert (
        qualify_service_name(ir, "http://localhost.otherns:80", "default")
        == "http://localhost.otherns:80"
    )
    assert (
        qualify_service_name(ir, "http://localhost.otherns:80", "otherns")
        == "http://localhost.otherns:80"
    )

    assert (
        normalize_service_name(ir, "http://localhost:80", None, "ConsulResolver")
        == "http://localhost:80"
    )
    assert (
        normalize_service_name(ir, "http://localhost:80", "default", "ConsulResolver")
        == "http://localhost:80"
    )
    assert (
        normalize_service_name(ir, "http://localhost:80", "otherns", "ConsulResolver")
        == "http://localhost:80"
    )
    # It's not meaningful to actually say "localhost.otherns", but it should passed through unchanged.
    assert (
    ...
    assert (
        qualify_service_name(ir, "https://localhost.otherns", "otherns")
        == "https://localhost.otherns"
    )

    assert (
        normalize_service_name(ir, "https://localhost", None, "ConsulResolver")
        == "https://localhost"
    )
    assert (
    ...
    assert (
        normalize_service_name(ir, "https://localhost", "otherns", "ConsulResolver")
        == "https://localhost"
    )
    # It's not meaningful to actually say "localhost.otherns", but it should passed through unchanged.
    assert (
        normalize_service_name(ir, "https://localhost.otherns", None, "ConsulResolver")
        == "https://localhost.otherns"
    )
    assert (
        normalize_service_name(
    ...
    assert (
        qualify_service_name(ir, "https://localhost.otherns:443", "default")
        == "https://localhost.otherns:443"
    )
    assert (
        qualify_service_name(ir, "https://localhost.otherns:443", "otherns")
        == "https://localhost.otherns:443"
    )

    assert (
        normalize_service_name(ir, "https://localhost:443", None, "ConsulResolver")
        == "https://localhost:443"
    )
    assert (
        normalize_service_name(ir, "https://localhost:443", "default", "ConsulResolver")
        == "https://localhost:443"
    )
    assert (
        normalize_service_name(ir, "https://localhost:443", "otherns", "ConsulResolver")
        == "https://localhost:443"
    )
    # It's not meaningful to actually say "localhost.otherns", but it should passed through unchanged.
    assert (
    ...
    assert (
        normalize_service_name(ir, "ambassador://foo.ns", "otherns", "ConsulResolver")
        == "ambassador://foo.ns"
    )  # let's not introduce silly semantics
    assert (
    ...
    assert (
        qualify_service_name(ir, "https://bad-service:443:443", "otherns")
    ...
    assert (
        normalize_service_name(ir, "bad-service:443:443", "otherns", "ConsulResolver")
        == "bad-service:443:443"
    )
    assert (
        normalize_service_name(
            ir, "https://[fe80::e022:9cff:fecc:c7c4:443", "otherns", "ConsulResolver"
        )
        == "https://[fe80::e022:9cff:fecc:c7c4:443"
    )
    assert (
    ...
    assert (
        errors[3]["error"]
        == "Malformed service 'https://[fe80::e022:9cff:fecc:c7c4:443': Invalid IPv6 URL"
    )

    assert not errors[4]["ok"]
    assert (
        errors[4]["error"]
        == "Malformed service 'https://[fe80::e022:9cff:fecc:c7c4': Invalid IPv6 URL"
    )
    ...
    assert (
        errors[7]["error"]
        == "Malformed service 'https://bad-service:70000': Port out of range 0-65535"
    )
    ...
    assert (
        errors[16]["error"]
        == "Malformed service 'https://[fe80::e022:9cff:fecc:c7c4%zone]:443': Invalid percent-escape in hostname: %zo"
    )
