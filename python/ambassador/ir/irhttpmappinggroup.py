...
class IRHTTPMappingGroup (IRBaseMappingGroup):
    ...
    def add_cluster_for_mapping(ir: 'IR', aconf: Config, mapping: IRBaseMapping,
        ...
        cluster = IRCluster(ir=ir, aconf=aconf,
                            ...
                            keepalive_time=mapping.get('keepalive_time', None),
                            keepalive_probes=mapping.get('keepalive_probes', None),
                            keepalive_interval=mapping.get('keepalive_interval', None),
