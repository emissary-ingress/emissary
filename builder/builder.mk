...
# `make release/prep-rc RC_NUMBER=N` is meant to be run by the human
# maintainer who is preparing to do a release.  It will create and
# push a v2.Y.Z-rc.N Git tag.
release/prep-rc:
