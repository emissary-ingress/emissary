...
- Feature: The Ambassador Module configuration now supports `strip_matching_host_port` to control whether the port should be removed from the Host/Authority header before any processing by request filters / routing.
