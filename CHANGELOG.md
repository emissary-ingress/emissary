...
- Feature: Ambassador now supports configuring error response bodies on 4XX and 5XX HTTP status codes, both for responses generated at Envoy and responses observed upstream.
