...
- Feature: Emissary-ingress now passes the client TLS certificate and SNI, if any, to the
  Authentication service. These are available in the `source.certificate` and `tls_session.sni`
  fields, as documented <a
  href="https://www.envoyproxy.io/docs/envoy/latest/api-v3/service/auth/v3/attribute_context.proto">in
  Envoy</a>.
