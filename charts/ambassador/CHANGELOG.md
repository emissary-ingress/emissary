...
- Update Ambassador chart image to version v2.14.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)

## v6.9.8

- Update Ambassador chart image to version v2.13.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)

## v6.9.7

- Update Ambassador chart image to version v2.12.1-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)
...
- Update Ambassador chart image to version v2.8.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)

## v6.9.3

- Update Ambassador chart image to version v2.7.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)

## v6.9.2

- Update Ambassador chart image to version v2.6.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)

## v6.9.1

- Update Ambassador chart image to version v2.5.0-wip: [CHANGELOG](https://github.com/datawire/ambassador/blob/master/CHANGELOG.md)
