...
ambassador-image: .ALWAYS
	docker build -t dwflynn/ambassador:0.1.5 ambassador
	docker push dwflynn/ambassador:0.1.5

sds-image: .ALWAYS
	docker build -t dwflynn/ambassador-sds:0.1.5 sds
	docker push dwflynn/ambassador-sds:0.1.5
