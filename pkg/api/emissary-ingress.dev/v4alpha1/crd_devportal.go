...
type DevPortalSpec struct {
	...
	NamingScheme string `json:"namingScheme,omitempty" v3:"naming_scheme,omitempty"`
	...
	PreserveServers *bool `json:"preserveServers,omitempty" v3:"preserve_servers,omitempty"`
}
