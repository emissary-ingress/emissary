...
type TraceConfig struct {
	AccessTokenFile   string `json:"accessTokenFile,omitempty" v3:"access_token_file,omitempty"`
	CollectorCluster  string `json:"collectorCluster,omitempty" v3:"collector_cluster,omitempty"`
	CollectorEndpoint string `json:"collectorEndpoint,omitempty" v3:"collector_endpoint,omitempty"`
	// +kubebuilder:validation:Enum=HTTP_JSON_V1;HTTP_JSON;HTTP_PROTO
	CollectorEndpointVersion string            `json:"collectorEndpointVersion,omitempty" v3:"collector_endpoint_version,omitempty"`
	CollectorHostname        string            `json:"collectorHostname,omitempty" v3:"collector_hostname,omitempty"`
	PropagationModes         []PropagationMode `json:"propagationModes,omitempty" v3:"propagation_modes,omitempty"`
	TraceID128Bit            *bool             `json:"traceID128bit,omitempty" v3:"trace_id_128bit,omitempty"`
	SharedSpanContext        *bool             `json:"sharedSpanContext,omitempty" v3:"shared_span_context,omitempty"`
	ServiceName              string            `json:"serviceName,omitempty" v3:"service_name,omitempty"`
}
...
type TracingCustomTagTypeEnvironment struct {
	...
	DefaultValue *string `json:"defaultValue,omitempty" v3:"default_value,omitempty"`
}
...
type TracingCustomTag struct {
	...
	// Environment or Header must be supplied.
	Header *TracingCustomTagTypeRequestHeader `json:"requestHeader,omitempty" v3:"request_header,omitempty"`
}
...
type TracingServiceSpec struct {
	...
	DeprecatedTagHeaders []string           `json:"tagHeaders,omitempty" v3:"tag_headers,omitempty"`
	CustomTags           []TracingCustomTag `json:"customTags,omitempty" v3:"custom_tags,omitempty"`
