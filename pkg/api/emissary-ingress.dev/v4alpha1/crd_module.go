...
type Features struct {
	...
	LinkerdHeaders bool `json:"linkerdHeaders,omitempty" v3:"linkerd_headers,omitempty"`

	// Should we enable the gRPC-http11 bridge?
	GrpcHttp11Bridge bool `json:"grpcHTTP11Bridge,omitempty" v3:"grpc_http11_bridge,omitempty"`

	// Should we enable the grpc-Web protocol?
	GrpcWeb bool `json:"grpcWeb,omitempty" v3:"grpc_web,omitempty"`
	...
	Ipv4Dns bool `json:"ipv4DNS,omitempty" v3:"ipv4_dns,omitempty"`

	// Should we do IPv6 DNS lookups when contacting services? Defaults to false,
	// but can be overridden in a [`Mapping`](/reference/mappings).
	Ipv6Dns bool `json:"ipv6DNS,omitempty" v3:"ipv6_dns,omitempty"`

	// liveness_probe defaults on, but you can disable the api route.
	// It will remain accessible on diag_port.
	LivenessProbe bool `json:"livenessProbe,omitempty" v3:"liveness_probe,omitempty"`

	// readiness_probe defaults on, but you can disable the api route.
	// It will remain accessible on diag_port.
	ReadinessProbe bool `json:"readinessProbe,omitempty" v3:"readiness_probe,omitempty"`
	...
	XffNumTrustedHops int `json:"xffNumTrustedHops,omitempty" v3:"xff_num_trusted_hops,omitempty"`

	// proxy_proto controls whether Envoy will honor the PROXY
	// protocol on incoming requests.
	ProxyProto bool `json:"proxyProto,omitempty" v3:"proxy_proto,omitempty"`
	...
	RemoteAddress bool `json:"remoteAddress,omitempty" v3:"remote_address,omitempty"`
	...
	XForwardedProtoRedirect bool `json:"xForwardedProtoRedirect,omitempty" v3:"x_forwarded_proto_redirect,omitempty"`
}
...
type AmbassadorConfigSpec struct {
	...
	// this.
	AdminPort int `json:"adminPort,omitempty" v3:"admin_port,omitempty"`

	// diag_port is the port where Ambassador will listen for requests
	// to the diagnostic service.
	DiagPort int `json:"diagPort,omitempty" v3:"diag_port,omitempty"`

	// By default Envoy sets server_name response header to 'envoy'
	// Override it with this variable
	ServerName string `json:"serverName,omitempty" v3:"server_name,omitempty"`
	...
	ServicePort int `json:"servicePort,omitempty" v3:"service_port,omitempty"`

	Features *Features `json:"features,omitempty"`

	// run a custom lua script on every request. see below for more details.
	LuaScripts string `json:"luaScripts,omitempty" v3:"lua_scripts,omitempty"`

	// +kubebuilder:validation:Enum={"text", "json", "typed_json"}
	EnvoyLogType string `json:"envoyLogType,omitempty" v3:"envoy_log_type,omitempty"`

	// envoy_log_path defines the path of log envoy will use. By default this is standard output
	EnvoyLogPath string `json:"envoyLogPath,omitempty" v3:"envoy_log_path,omitempty"`
	...
	// +kubebuilder:validation:MinItems=1
	HeaderCaseOverrides []string `json:"headerCaseOverrides,omitempty" v3:"header_case_overrides,omitempty"`
	...
	ClusterRequestTimeout *MillisecondDuration `json:"clusterRequestTimeoutMS,omitempty" v3:"cluster_request_timeout_ms,omitempty"`
	...
	RegexType string `json:"regexType,omitempty" v3:"regex_type,omitempty"`
	...
	RegexMaxSize int `json:"regexMaxSize,omitempty" v3:"regex_max_size,omitempty"`
}
