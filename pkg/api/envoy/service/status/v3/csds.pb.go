...
import (
	...
	v31 "github.com/datawire/ambassador/pkg/api/envoy/admin/v3"
...
type PerXdsConfig_ListenerConfig struct {
	ListenerConfig *v31.ListenersConfigDump `protobuf:"bytes,2,opt,name=listener_config,json=listenerConfig,proto3,oneof" json:"listener_config,omitempty"`
}
type PerXdsConfig_ClusterConfig struct {
	ClusterConfig *v31.ClustersConfigDump `protobuf:"bytes,3,opt,name=cluster_config,json=clusterConfig,proto3,oneof" json:"cluster_config,omitempty"`
}
type PerXdsConfig_RouteConfig struct {
	RouteConfig *v31.RoutesConfigDump `protobuf:"bytes,4,opt,name=route_config,json=routeConfig,proto3,oneof" json:"route_config,omitempty"`
}
type PerXdsConfig_ScopedRouteConfig struct {
	ScopedRouteConfig *v31.ScopedRoutesConfigDump `protobuf:"bytes,5,opt,name=scoped_route_config,json=scopedRouteConfig,proto3,oneof" json:"scoped_route_config,omitempty"`
}
...
func init() {
	proto.RegisterFile("envoy/service/status/v3/csds.proto", fileDescriptor_d6ae65ba18d04178)
}

var fileDescriptor_d6ae65ba18d04178 = []byte{
	// 737 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ClientStatusRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.NodeMatchers = append(m.NodeMatchers, &v3.NodeMatcher{})
