...
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Http1ProtocolOptions_HeaderKeyFormat) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.HeaderFormat.(*Http1ProtocolOptions_HeaderKeyFormat_Custom_); ok {
...
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom_) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom_) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Custom != nil {
...
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom_) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
