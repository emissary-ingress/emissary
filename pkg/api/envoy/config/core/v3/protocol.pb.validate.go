...
// Http1ProtocolOptions_HeaderKeyFormat_CustomMultiError, or nil if none found.
func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) ValidateAll() error {
	return m.validate(true)
}

func (m *Http1ProtocolOptions_HeaderKeyFormat_Custom) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Http1ProtocolOptions_HeaderKeyFormat_CustomMultiError(errors)
	}

	return nil
}

// Http1ProtocolOptions_HeaderKeyFormat_CustomMultiError is an error wrapping
// multiple validation errors returned by
// Http1ProtocolOptions_HeaderKeyFormat_Custom.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m Http1ProtocolOptions_HeaderKeyFormat_CustomMultiError) AllErrors() []error { return m }
