...
import (
	...
	envoy_api_v3alpha_core "github.com/datawire/ambassador/pkg/api/envoy/api/v3alpha/core"
)
...
func (m *HTTPRequestProperties) Validate() error {
	...
	if _, ok := envoy_api_v3alpha_core.RequestMethod_name[int32(m.GetRequestMethod())]; !ok {
