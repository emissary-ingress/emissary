...
func (in *CORS) DeepCopyInto(out *CORS) {
	*out = *in
	if in.Origins != nil {
		...
		*out = new(StringLiteralOrStringList)
		(*in).DeepCopyInto(*out)
	}
	if in.Methods != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StringLiteralOrStringList) DeepCopyInto(out *StringLiteralOrStringList) {
	*out = *in
	if in.String != nil {
		in, out := &in.String, &out.String
		*out = new(string)
	...
	if in.ListOfStrings != nil {
		in, out := &in.ListOfStrings, &out.ListOfStrings
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StringLiteralOrStringList.
func (in *StringLiteralOrStringList) DeepCopy() *StringLiteralOrStringList {
	if in == nil {
		return nil
	}
	out := new(StringLiteralOrStringList)
