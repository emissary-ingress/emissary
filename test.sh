...
./bin_linux_amd64/max-load --csv-file=04-pro-https2-base.csv       nodeport+https://ambassador.no-pro/load-testing/base/
./bin_linux_amd64/max-load --csv-file=05-pro-https2-rl-minute.csv  nodeport+https://ambassador.no-pro/load-testing/rl-minute/
./bin_linux_amd64/max-load --csv-file=06-pro-https2-rl-second.csv  nodeport+https://ambassador.no-pro/load-testing/rl-second/
./bin_linux_amd64/max-load --csv-file=07-pro-https2-filter-jwt.csv nodeport+https://ambassador.no-pro/load-testing/filter-jwt/
