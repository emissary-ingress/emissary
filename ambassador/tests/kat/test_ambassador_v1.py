...
#         assert "x-forwarded-for" in self.results[3].backend.request.headers
#         assert "user-agent" in self.results[3].backend.request.headers
#         assert "baz" not in self.results[3].backend.request.headers
