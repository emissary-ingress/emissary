...
import (
	fmt "fmt"
	v23 "github.com/datawire/kat-backend/xds/envoy/api/v2"
	auth "github.com/datawire/kat-backend/xds/envoy/api/v2/auth"
	core "github.com/datawire/kat-backend/xds/envoy/api/v2/core"
	v2 "github.com/datawire/kat-backend/xds/envoy/config/metrics/v2"
	v2alpha "github.com/datawire/kat-backend/xds/envoy/config/overload/v2alpha"
	v22 "github.com/datawire/kat-backend/xds/envoy/config/ratelimit/v2"
	v21 "github.com/datawire/kat-backend/xds/envoy/config/trace/v2"
...
var fileDescriptor_f1197defdf9c5e6a = []byte{
	...
	,
}
