...
type Config struct {
	...
	RedisPerSecondSocketType   string `env:"REDIS_PERSECOND_SOCKET_TYPE   ,parser=possibly-empty-string ,default="` // validated manually
	RedisPerSecondURL          string `env:"REDIS_PERSECOND_URL           ,parser=possibly-empty-string ,default="` // validated manually
