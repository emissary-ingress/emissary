...
export class HostCollection extends IResourceCollection {
  ...
  /* extend */
  constructor() {
    super(new ResourceStore(HostResource));
...
/**
 * The AllHosts object manages every Host instance and synchronizes the list of Hosts that are instantiated with the
 * real world of Kubernetes.
 */
