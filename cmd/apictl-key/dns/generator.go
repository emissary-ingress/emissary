...
// generateRandomName generates a random name from the list of adjectives and surnames in this package
// formatted as "adjective-surname". For example 'focused-turing'. A random integer
// between 0 and 9999 will be added to the end of the name, e.g `focused-turing-3`
...
begin:
	...
	return fmt.Sprintf("%s-%d", name, rand.Intn(9999))
}
