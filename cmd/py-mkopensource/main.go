...
func parseLicenses(name, version, license string) map[License]struct{} {
	override, ok := map[tuple][]License{
		...
		{"chardet", "4.0.0", "LGPL"}:                   {LGPL21},
		{"colorama", "0.4.3", "BSD"}:                   {BSD3},
		{"decorator", "5.0.9", "new BSD License"}:      {BSD2},
		{"gitdb", "4.0.7", "BSD License"}:              {BSD3},
		...
		{"jsonpointer", "2.1", "Modified BSD License"}: {BSD3},
		{"jsonschema", "3.2.0", "UNKNOWN"}:             {MIT},
		{"lockfile", "0.12.2", "UNKNOWN"}:              {MIT},
		{"oauthlib", "3.1.0", "BSD"}:                   {BSD3},
		{"pep517", "0.11.0", "None"}:                   {MIT},
		{"pip-tools", "6.2.0", "BSD 3 Clause"}:         {BSD3},
		...
		{"tomli", "1.2.1", "None"}:                     {MIT},
		{"webencodings", "0.5.1", "BSD"}:               {BSD3},
		{"websocket-client", "1.2.1", "Apache-2.0"}:    {Apache2},
		...
		{"types-PyYAML", "5.4.10", "Apache-2.0 license"}:     {Apache2},
		{"types-futures", "3.3.0", "Apache-2.0 license"}:     {Apache2},
		{"types-protobuf", "3.17.4", "Apache-2.0 license"}:   {Apache2},
		{"types-requests", "2.25.6", "Apache-2.0 license"}:   {Apache2},
		{"types-setuptools", "57.0.2", "Apache-2.0 license"}: {Apache2},
